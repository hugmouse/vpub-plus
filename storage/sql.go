...
$$ LANGUAGE plpgsql;
`,
	"schema_version_11": `-- Add image proxy settings
...
`,
	"schema_version_14": `-- Add indexes for foreign keys and common query patterns
...
`,
	"schema_version_15": `CREATE TABLE sessions (
...
`,
	"schema_version_16": `CREATE TABLE groups (
